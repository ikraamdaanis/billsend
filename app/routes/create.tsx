...
// rendered client-only. Server-rendering it would ship interactive inputs in
// the initial HTML that React has not attached handlers to yet; keystrokes in
// that pre-hydration window would be silently discarded when React reconciles
// the inputs back to their default values. ClientOnly renders the fallback
// through hydration and only mounts the editor once React is interactive.
